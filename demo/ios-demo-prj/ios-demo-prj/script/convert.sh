...
# since the proj. is including sqlighter files through gradle
# we need tp tmp bring these files directly into j2objc conversion
...
# remove temporarily brought sqlighter files
